			...
			require("kanagawa").setup({
				...
				overrides = function(colors) -- add/modify highlights
					...
					return {
						...
						-- Match bufferline background and separators to Kanagawa
						...
						BufferLineSeparatorVisible = { fg = theme.ui.bg_dim, bg = theme.ui.bg_dim },
						BufferLineSeparatorSelected = { fg = theme.ui.bg_dim, bg = theme.ui.bg_dim },
						BufferLineBufferSelected = { fg = theme.syn.identifier, bold = true, italic = false },
						BufferLineModified = { fg = theme.syn.constant, bg = theme.ui.bg_dim },
					}
				end,
